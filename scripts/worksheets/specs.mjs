...
export const TOPICS = {
  "GCSE/IGCSE": {
    ...
    Chemistry: {
      AQA: [
        ["unit-1", "Unit 1 — Atomic structure and the periodic table"],
        ["unit-2", "Unit 2 — Bonding, structure and the properties of matter"],
        ["unit-3", "Unit 3 — Quantitative chemistry"],
        ["unit-4", "Unit 4 — Chemical changes"],
        ["unit-5", "Unit 5 — Energy changes"],
        ["unit-6", "Unit 6 — The rate and extent of chemical change"],
        ["unit-7", "Unit 7 — Organic chemistry"],
        ["unit-8", "Unit 8 — Chemical analysis"],
        ["unit-9", "Unit 9 — Chemistry of the atmosphere"],
        ["unit-10", "Unit 10 — Using resources"],
      ],
      Edexcel: [
        ["unit-1", "Unit 1 — Key concepts in chemistry"],
        ["unit-2", "Unit 2 — States of matter and mixtures"],
        ["unit-3", "Unit 3 — Chemical changes"],
        ["unit-4", "Unit 4 — Extracting metals and equilibria"],
        ["unit-5", "Unit 5 — Separate chemistry 1"],
        ["unit-6", "Unit 6 — Separate chemistry 2"],
      ],
      OCR: [
        ["unit-1", "Unit 1 — C1 Particles"],
        ["unit-2", "Unit 2 — C2 Elements, compounds and mixtures"],
        ["unit-3", "Unit 3 — C3 Chemical reactions"],
        ["unit-4", "Unit 4 — C4 Predicting and identifying reactions and products"],
        ["unit-5", "Unit 5 — C5 Monitoring and controlling chemical reactions"],
        ["unit-6", "Unit 6 — C6 Global challenges"],
      ],
      WJEC: [
        ["unit-1", "Unit 1 — The nature of substances and chemical reactions"],
        ["unit-2", "Unit 2 — Atomic structure and the periodic table"],
        ["unit-3", "Unit 3 — Water and solutions"],
        ["unit-4", "Unit 4 — The ever-changing Earth"],
        ["unit-5", "Unit 5 — Rate of chemical change"],
        ["unit-6", "Unit 6 — Organic chemistry and fuels"],
        ["unit-7", "Unit 7 — Chemical analysis"],
      ],
    },
    Physics: {
      AQA: [
