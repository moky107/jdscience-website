...
// Never put SUPABASE_SERVICE_ROLE_KEY in the browser bundle.
const SUPABASE_URL =
...
if (/service_role/i.test(String(SUPABASE_ANON_KEY))) {
  throw new Error("Refusing to initialise the browser Supabase client with a service-role key.");
}
