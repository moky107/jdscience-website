...
function Navbar() {
  return (
    <nav style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'16px 40px',background:'#fff',position:'sticky',top:0,zIndex:100,boxShadow:'0 1px 6px rgba(0,0,0,.08)'}}>
