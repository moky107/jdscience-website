...
export const TERMS_ACCEPTANCE_ERROR =
  "You must read and agree to the Terms and Conditions before continuing.";
...
export const TERMS_SECTIONS = [
  {
    ...
    paragraphs: [
      "These Terms and Conditions (\"Terms\") govern use of the JD Science website at jdscience.co.uk and related services (the \"Platform\"). The Platform is operated by JD Science (\"we\", \"us\", \"our\"). Contact: info@jdscience.co.uk.",
      "By creating an account, applying to be listed as a tutor, booking a session, or otherwise using the Platform, you agree to these Terms. If you do not agree, you must not register or use the Platform.",
      "These Terms apply to visitors, registered users, students, parents or guardians, and independent tutors. Where you act for a child under 18, you agree on their behalf and remain responsible for their use of the Platform.",
    ],
  },
  {
    id: "platform",
  ...
  {
    id: "no-results",
    title: "6. No guarantee of academic results",
    paragraphs: [
      "The Platform, resources, worksheets, videos, advice articles and any tuition (whether JD Science's own or an independent tutor's) are educational support tools. They are not a substitute for school or college teaching, and they do not guarantee improved grades, exam success, predicted grades, coursework marks, or university, apprenticeship or employment outcomes.",
      "Past-paper links point to official awarding-body materials. Those materials remain the copyright of the relevant awarding organisation. JD Science does not claim ownership of official exam papers and does not warrant that any linked paper, mark scheme or specification is complete, current or suitable for a particular candidate.",
    ],
  },
  {
    id: "resources",
    title: "7. Resources, intellectual property and acceptable use",
    paragraphs: [
      "Original JD Science worksheets, notes and site content are owned by JD Science or our licensors. You may use them for personal study. You must not sell, republish, scrape or commercially exploit them without our written permission.",
      "You must not use the Platform to harass, defame, impersonate, upload malware, collect personal data unlawfully, post unlawful content, or attempt to interfere with the site or other users' accounts.",
      "You are responsible for keeping login details confidential. Notify us promptly if you believe an account has been misused.",
    ],
  },
  {
    id: "under-18",
  ...
  {
    id: "accounts",
    title: "9. Registration and accounts",
    paragraphs: [
      "Anybody registering as a visitor, student, parent or tutor must read and agree to these Terms before an account or application can be submitted. We may refuse registration, suspend accounts, or decline tutor applications without giving reasons, including where we believe these Terms have been breached.",
      "Past papers, worksheets, revision notes, videos and other items in the resource library are available to registered users only. First-time visitors must create an account before they can open those resources. On later visits, log in to access the library.",
      "You must provide accurate contact details and keep them up to date. We may send service messages about your account, bookings or application to the email address you supply.",
    ],
  },
  {
    id: "payments",
    title: "10. Payments, trials and cancellations",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: [
      "We may update these Terms from time to time. The version and date at the top of this page apply. Continued use of the Platform after a change means you accept the updated Terms. We may ask you to re-confirm acceptance when you next register, apply or book.",
      "These Terms are governed by the laws of England and Wales. The courts of England and Wales have exclusive jurisdiction, except that consumers may also bring claims in their local UK court where the law allows.",
      "Questions about these Terms: info@jdscience.co.uk.",
    ],
  },
];
